class DeveloperToolsPrompts:
    """
    Collection of prompts for analysis developer tools and technologies
    """
    TOOL_EXTRACTION_PROMPT="""
                            You are a tech researcher, Extract specific tools, library, platform, or service names from articles.
